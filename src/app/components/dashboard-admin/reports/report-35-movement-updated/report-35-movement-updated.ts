...
@Component({
  selector: 'app-report-35-movement-updated',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './report-35-movement-updated.html',
  styleUrl: './report-35-movement-updated.css'
})
export class Report35MovementUpdated implements OnInit {
