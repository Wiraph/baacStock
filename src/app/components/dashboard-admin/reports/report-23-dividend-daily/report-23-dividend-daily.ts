...
@Component({
  selector: 'app-report-23-dividend-daily',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './report-23-dividend-daily.html',
  styleUrl: './report-23-dividend-daily.css'
})
export class Report23DividendDaily implements OnInit {
